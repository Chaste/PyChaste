...
py::class_<ConstBoundaryCondition3 , ConstBoundaryCondition3_Overloads , boost::shared_ptr<ConstBoundaryCondition3 >  , AbstractBoundaryCondition<3>  >(m, "ConstBoundaryCondition3")
