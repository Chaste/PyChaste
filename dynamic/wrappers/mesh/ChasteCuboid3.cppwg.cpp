...
class ChasteCuboid3_Overloads : public ChasteCuboid3{
    public:
...
py::class_<ChasteCuboid3 , ChasteCuboid3_Overloads , boost::shared_ptr<ChasteCuboid3 >  , AbstractChasteRegion<3>  >(m, "ChasteCuboid3")
