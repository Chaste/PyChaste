...
class ChasteEllipsoid2_Overloads : public ChasteEllipsoid2{
    public:
...
py::class_<ChasteEllipsoid2 , ChasteEllipsoid2_Overloads , boost::shared_ptr<ChasteEllipsoid2 >  , AbstractChasteRegion<2>  >(m, "ChasteEllipsoid2")
