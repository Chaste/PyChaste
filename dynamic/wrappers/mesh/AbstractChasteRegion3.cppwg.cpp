...
class AbstractChasteRegion3_Overloads : public AbstractChasteRegion3{
    public:
...
py::class_<AbstractChasteRegion3 , AbstractChasteRegion3_Overloads , boost::shared_ptr<AbstractChasteRegion3 >   >(m, "AbstractChasteRegion3")
        .def(py::init< >())
        .def(
            "Destroy", 
