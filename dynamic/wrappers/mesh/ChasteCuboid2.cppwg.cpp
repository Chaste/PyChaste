...
class ChasteCuboid2_Overloads : public ChasteCuboid2{
    public:
...
py::class_<ChasteCuboid2 , ChasteCuboid2_Overloads , boost::shared_ptr<ChasteCuboid2 >  , AbstractChasteRegion<2>  >(m, "ChasteCuboid2")
