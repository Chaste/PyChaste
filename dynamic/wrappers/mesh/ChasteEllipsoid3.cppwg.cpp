...
class ChasteEllipsoid3_Overloads : public ChasteEllipsoid3{
    public:
...
py::class_<ChasteEllipsoid3 , ChasteEllipsoid3_Overloads , boost::shared_ptr<ChasteEllipsoid3 >  , AbstractChasteRegion<3>  >(m, "ChasteEllipsoid3")
