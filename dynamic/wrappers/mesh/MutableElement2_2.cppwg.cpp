...
class MutableElement2_2_Overloads : public MutableElement2_2{
    public:
...
py::class_<MutableElement2_2 , MutableElement2_2_Overloads , boost::shared_ptr<MutableElement2_2 >  , AbstractElement<2, 2>  >(m, "MutableElement2_2")
