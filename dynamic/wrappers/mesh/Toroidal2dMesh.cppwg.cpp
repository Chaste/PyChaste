...
class Toroidal2dMesh_Overloads : public Toroidal2dMesh{
    public:
...
py::class_<Toroidal2dMesh , Toroidal2dMesh_Overloads , boost::shared_ptr<Toroidal2dMesh >  , MutableMesh<2, 2>  >(m, "Toroidal2dMesh")
