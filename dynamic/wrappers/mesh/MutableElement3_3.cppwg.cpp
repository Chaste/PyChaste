...
class MutableElement3_3_Overloads : public MutableElement3_3{
    public:
...
py::class_<MutableElement3_3 , MutableElement3_3_Overloads , boost::shared_ptr<MutableElement3_3 >  , AbstractElement<3, 3>  >(m, "MutableElement3_3")
