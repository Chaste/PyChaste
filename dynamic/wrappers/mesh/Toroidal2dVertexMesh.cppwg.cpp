...
class Toroidal2dVertexMesh_Overloads : public Toroidal2dVertexMesh{
    public:
...
py::class_<Toroidal2dVertexMesh , Toroidal2dVertexMesh_Overloads , boost::shared_ptr<Toroidal2dVertexMesh >  , MutableVertexMesh<2, 2>  >(m, "Toroidal2dVertexMesh")
