...
class AbstractChasteRegion2_Overloads : public AbstractChasteRegion2{
    public:
...
py::class_<AbstractChasteRegion2 , AbstractChasteRegion2_Overloads , boost::shared_ptr<AbstractChasteRegion2 >   >(m, "AbstractChasteRegion2")
        .def(py::init< >())
        .def(
            "Destroy", 
