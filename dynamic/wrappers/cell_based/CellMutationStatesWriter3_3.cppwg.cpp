...
class CellMutationStatesWriter3_3_Overloads : public CellMutationStatesWriter3_3{
    public:
...
py::class_<CellMutationStatesWriter3_3 , CellMutationStatesWriter3_3_Overloads , boost::shared_ptr<CellMutationStatesWriter3_3 >  , AbstractCellWriter<3, 3>  >(m, "CellMutationStatesWriter3_3")
        .def(py::init< >())
        .def(
            "GetCellDataForVtkOutput", 
            (double(CellMutationStatesWriter3_3::*)(::CellPtr, ::AbstractCellPopulation<3, 3> *)) &CellMutationStatesWriter3_3::GetCellDataForVtkOutput, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
        .def(
            "VisitCell", 
            (void(CellMutationStatesWriter3_3::*)(::CellPtr, ::AbstractCellPopulation<3, 3> *)) &CellMutationStatesWriter3_3::VisitCell, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
    ;
}
