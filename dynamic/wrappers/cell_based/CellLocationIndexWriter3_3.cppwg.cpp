...
class CellLocationIndexWriter3_3_Overloads : public CellLocationIndexWriter3_3{
    public:
...
py::class_<CellLocationIndexWriter3_3 , CellLocationIndexWriter3_3_Overloads , boost::shared_ptr<CellLocationIndexWriter3_3 >  , AbstractCellWriter<3, 3>  >(m, "CellLocationIndexWriter3_3")
        .def(py::init< >())
        .def(
            "GetCellDataForVtkOutput", 
            (double(CellLocationIndexWriter3_3::*)(::CellPtr, ::AbstractCellPopulation<3, 3> *)) &CellLocationIndexWriter3_3::GetCellDataForVtkOutput, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
        .def(
            "VisitCell", 
            (void(CellLocationIndexWriter3_3::*)(::CellPtr, ::AbstractCellPopulation<3, 3> *)) &CellLocationIndexWriter3_3::VisitCell, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
    ;
}
