...
class CellRemovalLocationsWriter2_2_Overloads : public CellRemovalLocationsWriter2_2{
    public:
...
py::class_<CellRemovalLocationsWriter2_2 , CellRemovalLocationsWriter2_2_Overloads , boost::shared_ptr<CellRemovalLocationsWriter2_2 >  , AbstractCellPopulationEventWriter<2, 2>  >(m, "CellRemovalLocationsWriter2_2")
        .def(py::init< >())
        .def(
            "VisitAnyPopulation", 
            (void(CellRemovalLocationsWriter2_2::*)(::AbstractCellPopulation<2, 2> *)) &CellRemovalLocationsWriter2_2::VisitAnyPopulation, 
            " " , py::arg("pCellPopulation") )
        .def(
            "Visit", 
            (void(CellRemovalLocationsWriter2_2::*)(::MeshBasedCellPopulation<2, 2> *)) &CellRemovalLocationsWriter2_2::Visit, 
            " " , py::arg("pCellPopulation") )
        .def(
            "Visit", 
