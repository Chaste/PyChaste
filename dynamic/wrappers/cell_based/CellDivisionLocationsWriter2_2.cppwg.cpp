...
class CellDivisionLocationsWriter2_2_Overloads : public CellDivisionLocationsWriter2_2{
    public:
...
py::class_<CellDivisionLocationsWriter2_2 , CellDivisionLocationsWriter2_2_Overloads , boost::shared_ptr<CellDivisionLocationsWriter2_2 >  , AbstractCellPopulationEventWriter<2, 2>  >(m, "CellDivisionLocationsWriter2_2")
        .def(py::init< >())
        .def(
            "VisitAnyPopulation", 
            (void(CellDivisionLocationsWriter2_2::*)(::AbstractCellPopulation<2, 2> *)) &CellDivisionLocationsWriter2_2::VisitAnyPopulation, 
            " " , py::arg("pCellPopulation") )
        .def(
            "Visit", 
            (void(CellDivisionLocationsWriter2_2::*)(::MeshBasedCellPopulation<2, 2> *)) &CellDivisionLocationsWriter2_2::Visit, 
            " " , py::arg("pCellPopulation") )
        .def(
            "Visit", 
