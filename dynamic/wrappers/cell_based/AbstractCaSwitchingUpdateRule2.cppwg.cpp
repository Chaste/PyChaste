...
class AbstractCaSwitchingUpdateRule2_Overloads : public AbstractCaSwitchingUpdateRule2{
    public:
...
py::class_<AbstractCaSwitchingUpdateRule2 , AbstractCaSwitchingUpdateRule2_Overloads , boost::shared_ptr<AbstractCaSwitchingUpdateRule2 >  , AbstractUpdateRule<2>  >(m, "AbstractCaSwitchingUpdateRule2")
        .def(
            "EvaluateSwitchingProbability", 
