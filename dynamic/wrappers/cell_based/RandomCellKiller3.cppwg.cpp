...
class RandomCellKiller3_Overloads : public RandomCellKiller3{
    public:
...
py::class_<RandomCellKiller3 , RandomCellKiller3_Overloads , boost::shared_ptr<RandomCellKiller3 >  , AbstractCellKiller<3>  >(m, "RandomCellKiller3")
