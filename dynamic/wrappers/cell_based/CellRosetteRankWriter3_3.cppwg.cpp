...
class CellRosetteRankWriter3_3_Overloads : public CellRosetteRankWriter3_3{
    public:
...
py::class_<CellRosetteRankWriter3_3 , CellRosetteRankWriter3_3_Overloads , boost::shared_ptr<CellRosetteRankWriter3_3 >  , AbstractCellWriter<3, 3>  >(m, "CellRosetteRankWriter3_3")
        .def(py::init< >())
        .def(
            "GetCellDataForVtkOutput", 
            (double(CellRosetteRankWriter3_3::*)(::CellPtr, ::AbstractCellPopulation<3, 3> *)) &CellRosetteRankWriter3_3::GetCellDataForVtkOutput, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
        .def(
            "VisitCell", 
            (void(CellRosetteRankWriter3_3::*)(::CellPtr, ::AbstractCellPopulation<3, 3> *)) &CellRosetteRankWriter3_3::VisitCell, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
    ;
}
