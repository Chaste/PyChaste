...
class CellDeltaNotchWriter3_3_Overloads : public CellDeltaNotchWriter3_3{
    public:
...
py::class_<CellDeltaNotchWriter3_3 , CellDeltaNotchWriter3_3_Overloads , boost::shared_ptr<CellDeltaNotchWriter3_3 >  , AbstractCellWriter<3, 3>  >(m, "CellDeltaNotchWriter3_3")
        .def(py::init< >())
        .def(
            "GetCellDataForVtkOutput", 
            (double(CellDeltaNotchWriter3_3::*)(::CellPtr, ::AbstractCellPopulation<3, 3> *)) &CellDeltaNotchWriter3_3::GetCellDataForVtkOutput, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
        .def(
            "VisitCell", 
            (void(CellDeltaNotchWriter3_3::*)(::CellPtr, ::AbstractCellPopulation<3, 3> *)) &CellDeltaNotchWriter3_3::VisitCell, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
    ;
}
