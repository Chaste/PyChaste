...
class CellsGeneratorAlwaysDivideCellCycleModel_2_Overloads : CellsGeneratorAlwaysDivideCellCycleModel_2{
    public:
...
py::class_<CellsGeneratorAlwaysDivideCellCycleModel_2  , boost::shared_ptr<CellsGeneratorAlwaysDivideCellCycleModel_2 >   >(m, "CellsGeneratorAlwaysDivideCellCycleModel_2")
        ...
        .def("GenerateBasic",
            ...
            &CellsGeneratorAlwaysDivideCellCycleModel_2_Overloads::GenerateBasic, " " , py::arg("numCells"),  py::arg("locationIndices") = std::vector<unsigned int>(), py::arg("pCellProliferativeType") = boost::shared_ptr<AbstractCellProperty>())
        .def("GenerateBasicRandom",
            ...
            &CellsGeneratorAlwaysDivideCellCycleModel_2_Overloads::GenerateBasicRandom, " " , py::arg("numCells"), py::arg("pCellProliferativeType") = boost::shared_ptr<AbstractCellProperty>())
        .def("GenerateGivenLocationIndices",
            ...
            &CellsGeneratorAlwaysDivideCellCycleModel_2_Overloads::GenerateGivenLocationIndices, " " , py::arg("locationIndices"), py::arg("pCellProliferativeType") = boost::shared_ptr<AbstractCellProperty>())
    ;
}
