...
class CellProliferativeTypesCountWriter2_2_Overloads : public CellProliferativeTypesCountWriter2_2{
    public:
...
py::class_<CellProliferativeTypesCountWriter2_2 , CellProliferativeTypesCountWriter2_2_Overloads , boost::shared_ptr<CellProliferativeTypesCountWriter2_2 >  , AbstractCellPopulationCountWriter<2, 2>  >(m, "CellProliferativeTypesCountWriter2_2")
        .def(py::init< >())
        .def(
            "VisitAnyPopulation", 
            (void(CellProliferativeTypesCountWriter2_2::*)(::AbstractCellPopulation<2, 2> *)) &CellProliferativeTypesCountWriter2_2::VisitAnyPopulation, 
            " " , py::arg("pCellPopulation") )
        .def(
            "Visit", 
            (void(CellProliferativeTypesCountWriter2_2::*)(::MeshBasedCellPopulation<2, 2> *)) &CellProliferativeTypesCountWriter2_2::Visit, 
            " " , py::arg("pCellPopulation") )
        .def(
            "Visit", 
