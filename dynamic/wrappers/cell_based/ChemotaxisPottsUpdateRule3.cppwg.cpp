...
class ChemotaxisPottsUpdateRule3_Overloads : public ChemotaxisPottsUpdateRule3{
    public:
...
py::class_<ChemotaxisPottsUpdateRule3 , ChemotaxisPottsUpdateRule3_Overloads , boost::shared_ptr<ChemotaxisPottsUpdateRule3 >  , AbstractPottsUpdateRule<3>  >(m, "ChemotaxisPottsUpdateRule3")
        .def(py::init< >())
        .def(
            "EvaluateHamiltonianContribution", 
