...
class BernoulliTrialCellCycleModel_Overloads : public BernoulliTrialCellCycleModel{
    public:
...
py::class_<BernoulliTrialCellCycleModel , BernoulliTrialCellCycleModel_Overloads , boost::shared_ptr<BernoulliTrialCellCycleModel >  , AbstractCellCycleModel  >(m, "BernoulliTrialCellCycleModel")
        .def(py::init< >())
        .def(
            "ReadyToDivide", 
