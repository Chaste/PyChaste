...
class RandomDirectionVertexBasedDivisionRule2_Overloads : public RandomDirectionVertexBasedDivisionRule2{
    public:
...
py::class_<RandomDirectionVertexBasedDivisionRule2 , RandomDirectionVertexBasedDivisionRule2_Overloads , boost::shared_ptr<RandomDirectionVertexBasedDivisionRule2 >  , AbstractVertexBasedDivisionRule<2>  >(m, "RandomDirectionVertexBasedDivisionRule2")
        .def(py::init< >())
        .def(
            "CalculateCellDivisionVector", 
