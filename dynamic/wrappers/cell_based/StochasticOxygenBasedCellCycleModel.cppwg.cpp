...
class StochasticOxygenBasedCellCycleModel_Overloads : public StochasticOxygenBasedCellCycleModel{
    public:
...
py::class_<StochasticOxygenBasedCellCycleModel , StochasticOxygenBasedCellCycleModel_Overloads , boost::shared_ptr<StochasticOxygenBasedCellCycleModel >  , SimpleOxygenBasedCellCycleModel  >(m, "StochasticOxygenBasedCellCycleModel")
        .def(py::init< >())
        .def(
            "InitialiseDaughterCell", 
