...
class DifferentialAdhesionGeneralisedLinearSpringForce3_3_Overloads : public DifferentialAdhesionGeneralisedLinearSpringForce3_3{
    public:
...
py::class_<DifferentialAdhesionGeneralisedLinearSpringForce3_3 , DifferentialAdhesionGeneralisedLinearSpringForce3_3_Overloads , boost::shared_ptr<DifferentialAdhesionGeneralisedLinearSpringForce3_3 >  , GeneralisedLinearSpringForce<3, 3>  >(m, "DifferentialAdhesionGeneralisedLinearSpringForce3_3")
        .def(py::init< >())
        .def(
            "VariableSpringConstantMultiplicationFactor", 
            (double(DifferentialAdhesionGeneralisedLinearSpringForce3_3::*)(unsigned int, unsigned int, ::AbstractCellPopulation<3, 3> &, bool)) &DifferentialAdhesionGeneralisedLinearSpringForce3_3::VariableSpringConstantMultiplicationFactor, 
