...
class BoundaryNodeWriter2_2_Overloads : public BoundaryNodeWriter2_2{
    public:
...
py::class_<BoundaryNodeWriter2_2 , BoundaryNodeWriter2_2_Overloads , boost::shared_ptr<BoundaryNodeWriter2_2 >  , AbstractCellPopulationWriter<2, 2>  >(m, "BoundaryNodeWriter2_2")
        .def(py::init< >())
        .def(
            "VisitAnyPopulation", 
            (void(BoundaryNodeWriter2_2::*)(::AbstractCellPopulation<2, 2> *)) &BoundaryNodeWriter2_2::VisitAnyPopulation, 
            " " , py::arg("pCellPopulation") )
        .def(
            "Visit", 
            (void(BoundaryNodeWriter2_2::*)(::MeshBasedCellPopulation<2, 2> *)) &BoundaryNodeWriter2_2::Visit, 
            " " , py::arg("pCellPopulation") )
        .def(
            "Visit", 
