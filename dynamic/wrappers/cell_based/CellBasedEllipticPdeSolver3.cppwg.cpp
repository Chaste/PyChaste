...
class CellBasedEllipticPdeSolver3_Overloads : public CellBasedEllipticPdeSolver3{
    public:
...
py::class_<CellBasedEllipticPdeSolver3 , CellBasedEllipticPdeSolver3_Overloads , boost::shared_ptr<CellBasedEllipticPdeSolver3 >   >(m, "CellBasedEllipticPdeSolver3")
