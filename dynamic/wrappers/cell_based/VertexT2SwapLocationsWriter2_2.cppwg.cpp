...
class VertexT2SwapLocationsWriter2_2_Overloads : public VertexT2SwapLocationsWriter2_2{
    public:
...
py::class_<VertexT2SwapLocationsWriter2_2 , VertexT2SwapLocationsWriter2_2_Overloads , boost::shared_ptr<VertexT2SwapLocationsWriter2_2 >  , AbstractCellPopulationWriter<2, 2>  >(m, "VertexT2SwapLocationsWriter2_2")
        .def(py::init< >())
        .def(
            "Visit", 
            (void(VertexT2SwapLocationsWriter2_2::*)(::MeshBasedCellPopulation<2, 2> *)) &VertexT2SwapLocationsWriter2_2::Visit, 
