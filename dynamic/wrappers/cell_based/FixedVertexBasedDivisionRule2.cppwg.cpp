...
class FixedVertexBasedDivisionRule2_Overloads : public FixedVertexBasedDivisionRule2{
    public:
...
py::class_<FixedVertexBasedDivisionRule2 , FixedVertexBasedDivisionRule2_Overloads , boost::shared_ptr<FixedVertexBasedDivisionRule2 >  , AbstractVertexBasedDivisionRule<2>  >(m, "FixedVertexBasedDivisionRule2")
