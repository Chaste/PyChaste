...
class AbstractCellPopulationEventWriter2_2_Overloads : public AbstractCellPopulationEventWriter2_2{
    public:
...
py::class_<AbstractCellPopulationEventWriter2_2 , AbstractCellPopulationEventWriter2_2_Overloads , boost::shared_ptr<AbstractCellPopulationEventWriter2_2 >  , AbstractCellBasedWriter<2, 2>  >(m, "AbstractCellPopulationEventWriter2_2")
        .def(py::init<::std::string const & >(), py::arg("rFileName"))
        .def(
            "WriteHeader", 
            (void(AbstractCellPopulationEventWriter2_2::*)(::AbstractCellPopulation<2, 2> *)) &AbstractCellPopulationEventWriter2_2::WriteHeader, 
            " " , py::arg("pCellPopulation") )
        .def(
            "Visit", 
            (void(AbstractCellPopulationEventWriter2_2::*)(::MeshBasedCellPopulation<2, 2> *)) &AbstractCellPopulationEventWriter2_2::Visit, 
            " " , py::arg("pCellPopulation") )
        .def(
            "Visit", 
