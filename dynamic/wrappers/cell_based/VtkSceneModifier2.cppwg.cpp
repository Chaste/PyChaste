...
py::class_<VtkSceneModifier2 , VtkSceneModifier2_Overloads , boost::shared_ptr<VtkSceneModifier2 > , AbstractCellBasedSimulationModifier<2, 2>  >(m, "VtkSceneModifier2")
        ...
        .def(
            "UpdateAtEndOfTimeStep", 
            (void(VtkSceneModifier2::*)(::AbstractCellPopulation<2, 2> &)) &VtkSceneModifier2::UpdateAtEndOfTimeStep, 
            " " , py::arg("rCellPopulation") )
        .def(
            "SetupSolve", 
            (void(VtkSceneModifier2::*)(::AbstractCellPopulation<2, 2> &, ::std::string)) &VtkSceneModifier2::SetupSolve, 
        ...
        .def(
            "UpdateCellData", 
            (void(VtkSceneModifier2::*)(::AbstractCellPopulation<2, 2> &)) &VtkSceneModifier2::UpdateCellData, 
            " " , py::arg("rCellPopulation") )
        .def(
            "OutputSimulationModifierParameters", 
