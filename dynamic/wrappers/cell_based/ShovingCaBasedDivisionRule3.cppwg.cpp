...
class ShovingCaBasedDivisionRule3_Overloads : public ShovingCaBasedDivisionRule3{
    public:
...
py::class_<ShovingCaBasedDivisionRule3 , ShovingCaBasedDivisionRule3_Overloads , boost::shared_ptr<ShovingCaBasedDivisionRule3 >  , AbstractCaBasedDivisionRule<3>  >(m, "ShovingCaBasedDivisionRule3")
        .def(py::init< >())
        .def(
            "IsNodeOnBoundary", 
