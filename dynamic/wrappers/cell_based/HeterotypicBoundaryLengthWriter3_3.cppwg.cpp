...
class HeterotypicBoundaryLengthWriter3_3_Overloads : public HeterotypicBoundaryLengthWriter3_3{
    public:
...
py::class_<HeterotypicBoundaryLengthWriter3_3 , HeterotypicBoundaryLengthWriter3_3_Overloads , boost::shared_ptr<HeterotypicBoundaryLengthWriter3_3 >  , AbstractCellPopulationWriter<3, 3>  >(m, "HeterotypicBoundaryLengthWriter3_3")
        .def(py::init< >())
        .def(
            "Visit", 
            (void(HeterotypicBoundaryLengthWriter3_3::*)(::MeshBasedCellPopulation<3, 3> *)) &HeterotypicBoundaryLengthWriter3_3::Visit, 
