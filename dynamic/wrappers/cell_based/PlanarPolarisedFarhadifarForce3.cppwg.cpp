...
class PlanarPolarisedFarhadifarForce3_Overloads : public PlanarPolarisedFarhadifarForce3{
    public:
...
py::class_<PlanarPolarisedFarhadifarForce3 , PlanarPolarisedFarhadifarForce3_Overloads , boost::shared_ptr<PlanarPolarisedFarhadifarForce3 >  , FarhadifarForce<3>  >(m, "PlanarPolarisedFarhadifarForce3")
        .def(py::init< >())
        .def(
