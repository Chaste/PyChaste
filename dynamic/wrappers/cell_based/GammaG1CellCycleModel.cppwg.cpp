...
class GammaG1CellCycleModel_Overloads : public GammaG1CellCycleModel{
    public:
...
py::class_<GammaG1CellCycleModel , GammaG1CellCycleModel_Overloads , boost::shared_ptr<GammaG1CellCycleModel >  , AbstractSimplePhaseBasedCellCycleModel  >(m, "GammaG1CellCycleModel")
        .def(py::init< >())
        .def(
            "SetG1Duration", 
