...
class CellIdWriter3_3_Overloads : public CellIdWriter3_3{
    public:
...
py::class_<CellIdWriter3_3 , CellIdWriter3_3_Overloads , boost::shared_ptr<CellIdWriter3_3 >  , AbstractCellWriter<3, 3>  >(m, "CellIdWriter3_3")
        .def(py::init< >())
        .def(
            "GetCellDataForVtkOutput", 
            (double(CellIdWriter3_3::*)(::CellPtr, ::AbstractCellPopulation<3, 3> *)) &CellIdWriter3_3::GetCellDataForVtkOutput, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
        .def(
            "VisitCell", 
            (void(CellIdWriter3_3::*)(::CellPtr, ::AbstractCellPopulation<3, 3> *)) &CellIdWriter3_3::VisitCell, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
    ;
}
