...
py::class_<AbstractPottsUpdateRule3 , AbstractPottsUpdateRule3_Overloads , boost::shared_ptr<AbstractPottsUpdateRule3 >  , AbstractUpdateRule<3>  >(m, "AbstractPottsUpdateRule3")
        .def(
            "EvaluateHamiltonianContribution", 
