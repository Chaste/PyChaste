...
class CellBasedEllipticPdeSolver2_Overloads : public CellBasedEllipticPdeSolver2{
    public:
...
py::class_<CellBasedEllipticPdeSolver2 , CellBasedEllipticPdeSolver2_Overloads , boost::shared_ptr<CellBasedEllipticPdeSolver2 >   >(m, "CellBasedEllipticPdeSolver2")
