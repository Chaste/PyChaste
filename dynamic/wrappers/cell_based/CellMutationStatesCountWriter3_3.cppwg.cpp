...
class CellMutationStatesCountWriter3_3_Overloads : public CellMutationStatesCountWriter3_3{
    public:
...
py::class_<CellMutationStatesCountWriter3_3 , CellMutationStatesCountWriter3_3_Overloads , boost::shared_ptr<CellMutationStatesCountWriter3_3 >  , AbstractCellPopulationCountWriter<3, 3>  >(m, "CellMutationStatesCountWriter3_3")
        .def(py::init< >())
        .def(
            "WriteHeader", 
            (void(CellMutationStatesCountWriter3_3::*)(::AbstractCellPopulation<3, 3> *)) &CellMutationStatesCountWriter3_3::WriteHeader, 
            " " , py::arg("pCellPopulation") )
        .def(
            "VisitAnyPopulation", 
            (void(CellMutationStatesCountWriter3_3::*)(::AbstractCellPopulation<3, 3> *)) &CellMutationStatesCountWriter3_3::VisitAnyPopulation, 
            " " , py::arg("pCellPopulation") )
        .def(
            "Visit", 
            (void(CellMutationStatesCountWriter3_3::*)(::MeshBasedCellPopulation<3, 3> *)) &CellMutationStatesCountWriter3_3::Visit, 
            " " , py::arg("pCellPopulation") )
        .def(
            "Visit", 
