...
class CellAppliedForceWriter2_2_Overloads : public CellAppliedForceWriter2_2{
    public:
...
py::class_<CellAppliedForceWriter2_2 , CellAppliedForceWriter2_2_Overloads , boost::shared_ptr<CellAppliedForceWriter2_2 >  , AbstractCellWriter<2, 2>  >(m, "CellAppliedForceWriter2_2")
        .def(py::init< >())
        .def(
            "GetVectorCellDataForVtkOutput", 
            (::boost::numeric::ublas::c_vector<double, 2>(CellAppliedForceWriter2_2::*)(::CellPtr, ::AbstractCellPopulation<2, 2> *)) &CellAppliedForceWriter2_2::GetVectorCellDataForVtkOutput, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
        .def(
            "VisitCell", 
            (void(CellAppliedForceWriter2_2::*)(::CellPtr, ::AbstractCellPopulation<2, 2> *)) &CellAppliedForceWriter2_2::VisitCell, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
    ;
}
