...
class FixedSequenceCellCycleModel_Overloads : public FixedSequenceCellCycleModel{
    public:
...
py::class_<FixedSequenceCellCycleModel , FixedSequenceCellCycleModel_Overloads , boost::shared_ptr<FixedSequenceCellCycleModel >  , ExponentialG1GenerationalCellCycleModel  >(m, "FixedSequenceCellCycleModel")
        .def(py::init< >())
        .def(
            "CreateCellCycleModel", 
