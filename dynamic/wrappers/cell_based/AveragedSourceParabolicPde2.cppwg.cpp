...
py::class_<AveragedSourceParabolicPde2 , AveragedSourceParabolicPde2_Overloads , boost::shared_ptr<AveragedSourceParabolicPde2 >   >(m, "AveragedSourceParabolicPde2")
