...
class TargetAreaLinearGrowthModifier3_Overloads : public TargetAreaLinearGrowthModifier3{
    public:
...
py::class_<TargetAreaLinearGrowthModifier3 , TargetAreaLinearGrowthModifier3_Overloads , boost::shared_ptr<TargetAreaLinearGrowthModifier3 >  , AbstractTargetAreaModifier<3>  >(m, "TargetAreaLinearGrowthModifier3")
        .def(py::init< >())
        .def(
            "UpdateTargetAreaOfCell", 
