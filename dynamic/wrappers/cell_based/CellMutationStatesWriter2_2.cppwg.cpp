...
class CellMutationStatesWriter2_2_Overloads : public CellMutationStatesWriter2_2{
    public:
...
py::class_<CellMutationStatesWriter2_2 , CellMutationStatesWriter2_2_Overloads , boost::shared_ptr<CellMutationStatesWriter2_2 >  , AbstractCellWriter<2, 2>  >(m, "CellMutationStatesWriter2_2")
        .def(py::init< >())
        .def(
            "GetCellDataForVtkOutput", 
            (double(CellMutationStatesWriter2_2::*)(::CellPtr, ::AbstractCellPopulation<2, 2> *)) &CellMutationStatesWriter2_2::GetCellDataForVtkOutput, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
        .def(
            "VisitCell", 
            (void(CellMutationStatesWriter2_2::*)(::CellPtr, ::AbstractCellPopulation<2, 2> *)) &CellMutationStatesWriter2_2::VisitCell, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
    ;
}
