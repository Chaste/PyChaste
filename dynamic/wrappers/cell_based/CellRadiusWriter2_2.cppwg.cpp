...
class CellRadiusWriter2_2_Overloads : public CellRadiusWriter2_2{
    public:
...
py::class_<CellRadiusWriter2_2 , CellRadiusWriter2_2_Overloads , boost::shared_ptr<CellRadiusWriter2_2 >  , AbstractCellWriter<2, 2>  >(m, "CellRadiusWriter2_2")
        .def(py::init< >())
        .def(
            "GetCellDataForVtkOutput", 
            (double(CellRadiusWriter2_2::*)(::CellPtr, ::AbstractCellPopulation<2, 2> *)) &CellRadiusWriter2_2::GetCellDataForVtkOutput, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
        .def(
            "VisitCell", 
            (void(CellRadiusWriter2_2::*)(::CellPtr, ::AbstractCellPopulation<2, 2> *)) &CellRadiusWriter2_2::VisitCell, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
    ;
}
