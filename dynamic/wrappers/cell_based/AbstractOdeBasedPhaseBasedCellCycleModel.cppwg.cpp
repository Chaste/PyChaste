...
class AbstractOdeBasedPhaseBasedCellCycleModel_Overloads : public AbstractOdeBasedPhaseBasedCellCycleModel{
    public:
...
py::class_<AbstractOdeBasedPhaseBasedCellCycleModel , AbstractOdeBasedPhaseBasedCellCycleModel_Overloads , boost::shared_ptr<AbstractOdeBasedPhaseBasedCellCycleModel >  , AbstractPhaseBasedCellCycleModel  >(m, "AbstractOdeBasedPhaseBasedCellCycleModel")
        .def(
            "UpdateCellCyclePhase", 
