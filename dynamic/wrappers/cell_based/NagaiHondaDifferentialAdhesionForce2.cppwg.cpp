...
class NagaiHondaDifferentialAdhesionForce2_Overloads : public NagaiHondaDifferentialAdhesionForce2{
    public:
...
py::class_<NagaiHondaDifferentialAdhesionForce2 , NagaiHondaDifferentialAdhesionForce2_Overloads , boost::shared_ptr<NagaiHondaDifferentialAdhesionForce2 >  , NagaiHondaForce<2>  >(m, "NagaiHondaDifferentialAdhesionForce2")
        .def(py::init< >())
        .def(
