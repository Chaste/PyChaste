...
class CellAncestorWriter3_3_Overloads : public CellAncestorWriter3_3{
    public:
...
py::class_<CellAncestorWriter3_3 , CellAncestorWriter3_3_Overloads , boost::shared_ptr<CellAncestorWriter3_3 >  , AbstractCellWriter<3, 3>  >(m, "CellAncestorWriter3_3")
        .def(py::init< >())
        .def(
            "GetCellDataForVtkOutput", 
            (double(CellAncestorWriter3_3::*)(::CellPtr, ::AbstractCellPopulation<3, 3> *)) &CellAncestorWriter3_3::GetCellDataForVtkOutput, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
        .def(
            "VisitCell", 
            (void(CellAncestorWriter3_3::*)(::CellPtr, ::AbstractCellPopulation<3, 3> *)) &CellAncestorWriter3_3::VisitCell, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
    ;
}
