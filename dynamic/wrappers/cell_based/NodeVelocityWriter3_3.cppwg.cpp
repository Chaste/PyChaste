...
class NodeVelocityWriter3_3_Overloads : public NodeVelocityWriter3_3{
    public:
...
py::class_<NodeVelocityWriter3_3 , NodeVelocityWriter3_3_Overloads , boost::shared_ptr<NodeVelocityWriter3_3 >  , AbstractCellPopulationWriter<3, 3>  >(m, "NodeVelocityWriter3_3")
        .def(py::init< >())
        .def(
            "Visit", 
            (void(NodeVelocityWriter3_3::*)(::MeshBasedCellPopulation<3, 3> *)) &NodeVelocityWriter3_3::Visit, 
