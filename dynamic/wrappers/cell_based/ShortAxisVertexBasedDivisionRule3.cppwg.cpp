...
class ShortAxisVertexBasedDivisionRule3_Overloads : public ShortAxisVertexBasedDivisionRule3{
    public:
...
py::class_<ShortAxisVertexBasedDivisionRule3 , ShortAxisVertexBasedDivisionRule3_Overloads , boost::shared_ptr<ShortAxisVertexBasedDivisionRule3 >  , AbstractVertexBasedDivisionRule<3>  >(m, "ShortAxisVertexBasedDivisionRule3")
        .def(py::init< >())
        .def(
            "CalculateCellDivisionVector", 
