...
class CellsGeneratorFixedG1GenerationalCellCycleModel_3_Overloads : CellsGeneratorFixedG1GenerationalCellCycleModel_3{
    ...
    std::vector<CellPtr> GenerateBasic(unsigned numCells, const std::vector<unsigned> locationIndices=std::vector<unsigned>(), boost::shared_ptr<AbstractCellProperty> pCellProliferativeType=boost::shared_ptr<AbstractCellProperty>())
    {
        ...
        CellsGeneratorFixedG1GenerationalCellCycleModel_3::GenerateBasic(cells, numCells, locationIndices, pCellProliferativeType);
        return cells;
    };
    ...
    {
        std::vector<CellPtr> cells;
        CellsGeneratorFixedG1GenerationalCellCycleModel_3::GenerateBasicRandom(cells, numCells, pCellProliferativeType);
        return cells;
    };
    ...
    {
        std::vector<CellPtr> cells;
        CellsGeneratorFixedG1GenerationalCellCycleModel_3::GenerateGivenLocationIndices(cells, locationIndices, pCellProliferativeType);
        return cells;
    };
};
...
py::class_<CellsGeneratorFixedG1GenerationalCellCycleModel_3  , boost::shared_ptr<CellsGeneratorFixedG1GenerationalCellCycleModel_3 >   >(m, "CellsGeneratorFixedG1GenerationalCellCycleModel_3")
        .def(py::init< >())
        .def(
            "GenerateBasic", 
            (void(CellsGeneratorFixedG1GenerationalCellCycleModel_3::*)(::std::vector<boost::shared_ptr<Cell>> &, unsigned int, ::std::vector<unsigned int> const, ::boost::shared_ptr<AbstractCellProperty>)) &CellsGeneratorFixedG1GenerationalCellCycleModel_3::GenerateBasic, 
        ...
        .def(
            "GenerateBasicRandom", 
            (void(CellsGeneratorFixedG1GenerationalCellCycleModel_3::*)(::std::vector<boost::shared_ptr<Cell>> &, unsigned int, ::boost::shared_ptr<AbstractCellProperty>)) &CellsGeneratorFixedG1GenerationalCellCycleModel_3::GenerateBasicRandom, 
