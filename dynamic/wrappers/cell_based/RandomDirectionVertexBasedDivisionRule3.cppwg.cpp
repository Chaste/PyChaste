...
class RandomDirectionVertexBasedDivisionRule3_Overloads : public RandomDirectionVertexBasedDivisionRule3{
    public:
...
py::class_<RandomDirectionVertexBasedDivisionRule3 , RandomDirectionVertexBasedDivisionRule3_Overloads , boost::shared_ptr<RandomDirectionVertexBasedDivisionRule3 >  , AbstractVertexBasedDivisionRule<3>  >(m, "RandomDirectionVertexBasedDivisionRule3")
        .def(py::init< >())
        .def(
            "CalculateCellDivisionVector", 
