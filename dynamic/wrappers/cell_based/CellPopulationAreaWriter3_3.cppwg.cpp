...
class CellPopulationAreaWriter3_3_Overloads : public CellPopulationAreaWriter3_3{
    public:
...
py::class_<CellPopulationAreaWriter3_3 , CellPopulationAreaWriter3_3_Overloads , boost::shared_ptr<CellPopulationAreaWriter3_3 >  , AbstractCellPopulationWriter<3, 3>  >(m, "CellPopulationAreaWriter3_3")
        .def(py::init< >())
        .def(
            "Visit", 
            (void(CellPopulationAreaWriter3_3::*)(::MeshBasedCellPopulation<3, 3> *)) &CellPopulationAreaWriter3_3::Visit, 
