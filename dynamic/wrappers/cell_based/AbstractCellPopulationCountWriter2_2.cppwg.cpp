...
class AbstractCellPopulationCountWriter2_2_Overloads : public AbstractCellPopulationCountWriter2_2{
    public:
...
py::class_<AbstractCellPopulationCountWriter2_2 , AbstractCellPopulationCountWriter2_2_Overloads , boost::shared_ptr<AbstractCellPopulationCountWriter2_2 >  , AbstractCellBasedWriter<2, 2>  >(m, "AbstractCellPopulationCountWriter2_2")
        .def(py::init<::std::string const & >(), py::arg("rFileName"))
        .def(
            "WriteHeader", 
            (void(AbstractCellPopulationCountWriter2_2::*)(::AbstractCellPopulation<2, 2> *)) &AbstractCellPopulationCountWriter2_2::WriteHeader, 
            " " , py::arg("pCellPopulation") )
        .def(
            "Visit", 
            (void(AbstractCellPopulationCountWriter2_2::*)(::MeshBasedCellPopulation<2, 2> *)) &AbstractCellPopulationCountWriter2_2::Visit, 
            " " , py::arg("pCellPopulation") )
        .def(
            "Visit", 
