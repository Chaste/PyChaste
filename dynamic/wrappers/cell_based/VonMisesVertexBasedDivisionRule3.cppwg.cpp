...
class VonMisesVertexBasedDivisionRule3_Overloads : public VonMisesVertexBasedDivisionRule3{
    public:
...
py::class_<VonMisesVertexBasedDivisionRule3 , VonMisesVertexBasedDivisionRule3_Overloads , boost::shared_ptr<VonMisesVertexBasedDivisionRule3 >  , AbstractVertexBasedDivisionRule<3>  >(m, "VonMisesVertexBasedDivisionRule3")
        .def(py::init< >())
        .def(
            "GetMeanParameter", 
