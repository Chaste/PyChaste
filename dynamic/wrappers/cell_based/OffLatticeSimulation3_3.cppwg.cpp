...
py::class_<OffLatticeSimulation3_3 , OffLatticeSimulation3_3_Overloads , boost::shared_ptr<OffLatticeSimulation3_3 >  , AbstractCellBasedSimulation<3, 3>  >(m, "OffLatticeSimulation3_3")
        ...
        .def(
            "rGetForceCollection", 
            (::std::vector<boost::shared_ptr<AbstractForce<3, 3> >, std::allocator<boost::shared_ptr<AbstractForce<3, 3> > > > const &(OffLatticeSimulation3_3::*)() const ) &OffLatticeSimulation3_3::rGetForceCollection, 
