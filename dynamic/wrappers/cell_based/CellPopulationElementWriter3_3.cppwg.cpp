...
class CellPopulationElementWriter3_3_Overloads : public CellPopulationElementWriter3_3{
    public:
...
py::class_<CellPopulationElementWriter3_3 , CellPopulationElementWriter3_3_Overloads , boost::shared_ptr<CellPopulationElementWriter3_3 >  , AbstractCellPopulationWriter<3, 3>  >(m, "CellPopulationElementWriter3_3")
        .def(py::init< >())
        .def(
            "Visit", 
            (void(CellPopulationElementWriter3_3::*)(::MeshBasedCellPopulation<3, 3> *)) &CellPopulationElementWriter3_3::Visit, 
