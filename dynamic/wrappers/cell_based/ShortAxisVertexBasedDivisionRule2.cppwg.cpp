...
class ShortAxisVertexBasedDivisionRule2_Overloads : public ShortAxisVertexBasedDivisionRule2{
    public:
...
py::class_<ShortAxisVertexBasedDivisionRule2 , ShortAxisVertexBasedDivisionRule2_Overloads , boost::shared_ptr<ShortAxisVertexBasedDivisionRule2 >  , AbstractVertexBasedDivisionRule<2>  >(m, "ShortAxisVertexBasedDivisionRule2")
        .def(py::init< >())
        .def(
            "CalculateCellDivisionVector", 
