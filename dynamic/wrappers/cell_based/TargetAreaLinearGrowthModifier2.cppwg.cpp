...
class TargetAreaLinearGrowthModifier2_Overloads : public TargetAreaLinearGrowthModifier2{
    public:
...
py::class_<TargetAreaLinearGrowthModifier2 , TargetAreaLinearGrowthModifier2_Overloads , boost::shared_ptr<TargetAreaLinearGrowthModifier2 >  , AbstractTargetAreaModifier<2>  >(m, "TargetAreaLinearGrowthModifier2")
        .def(py::init< >())
        .def(
            "UpdateTargetAreaOfCell", 
