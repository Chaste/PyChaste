...
class AbstractCellWriter2_2_Overloads : public AbstractCellWriter2_2{
    public:
...
py::class_<AbstractCellWriter2_2 , AbstractCellWriter2_2_Overloads , boost::shared_ptr<AbstractCellWriter2_2 >  , AbstractCellBasedWriter<2, 2>  >(m, "AbstractCellWriter2_2")
        .def(py::init<::std::string const & >(), py::arg("rFileName"))
        .def(
            "GetCellDataForVtkOutput", 
            (double(AbstractCellWriter2_2::*)(::CellPtr, ::AbstractCellPopulation<2, 2> *)) &AbstractCellWriter2_2::GetCellDataForVtkOutput, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
        .def(
            "GetVectorCellDataForVtkOutput", 
            (::boost::numeric::ublas::c_vector<double, 2>(AbstractCellWriter2_2::*)(::CellPtr, ::AbstractCellPopulation<2, 2> *)) &AbstractCellWriter2_2::GetVectorCellDataForVtkOutput, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
        .def(
            "VisitCell", 
            (void(AbstractCellWriter2_2::*)(::CellPtr, ::AbstractCellPopulation<2, 2> *)) &AbstractCellWriter2_2::VisitCell, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
        .def(
            "GetOutputScalarData", 
