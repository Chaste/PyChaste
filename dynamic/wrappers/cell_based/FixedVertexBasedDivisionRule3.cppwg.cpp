...
class FixedVertexBasedDivisionRule3_Overloads : public FixedVertexBasedDivisionRule3{
    public:
...
py::class_<FixedVertexBasedDivisionRule3 , FixedVertexBasedDivisionRule3_Overloads , boost::shared_ptr<FixedVertexBasedDivisionRule3 >  , AbstractVertexBasedDivisionRule<3>  >(m, "FixedVertexBasedDivisionRule3")
