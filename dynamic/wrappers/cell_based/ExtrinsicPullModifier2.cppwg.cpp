...
py::class_<ExtrinsicPullModifier2 , ExtrinsicPullModifier2_Overloads , boost::shared_ptr<ExtrinsicPullModifier2 > , AbstractCellBasedSimulationModifier<2, 2>  >(m, "ExtrinsicPullModifier2")
        .def(py::init< >())
        .def(
            "UpdateAtEndOfTimeStep", 
