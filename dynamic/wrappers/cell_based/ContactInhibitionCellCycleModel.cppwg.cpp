...
class ContactInhibitionCellCycleModel_Overloads : public ContactInhibitionCellCycleModel{
    public:
...
py::class_<ContactInhibitionCellCycleModel , ContactInhibitionCellCycleModel_Overloads , boost::shared_ptr<ContactInhibitionCellCycleModel >  , AbstractSimplePhaseBasedCellCycleModel  >(m, "ContactInhibitionCellCycleModel")
        .def(py::init< >())
        .def(
            "UpdateCellCyclePhase", 
