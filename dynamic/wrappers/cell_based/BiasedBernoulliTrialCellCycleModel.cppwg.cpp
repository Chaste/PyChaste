...
class BiasedBernoulliTrialCellCycleModel_Overloads : public BiasedBernoulliTrialCellCycleModel{
    public:
...
py::class_<BiasedBernoulliTrialCellCycleModel , BiasedBernoulliTrialCellCycleModel_Overloads , boost::shared_ptr<BiasedBernoulliTrialCellCycleModel >  , AbstractCellCycleModel  >(m, "BiasedBernoulliTrialCellCycleModel")
        .def(py::init< >())
        .def(
            "ReadyToDivide", 
