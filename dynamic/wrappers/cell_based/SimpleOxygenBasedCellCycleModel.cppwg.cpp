...
py::class_<SimpleOxygenBasedCellCycleModel , SimpleOxygenBasedCellCycleModel_Overloads , boost::shared_ptr<SimpleOxygenBasedCellCycleModel >  , AbstractSimplePhaseBasedCellCycleModel  >(m, "SimpleOxygenBasedCellCycleModel")
        .def(py::init< >())
        .def(
            "UpdateCellCyclePhase", 
