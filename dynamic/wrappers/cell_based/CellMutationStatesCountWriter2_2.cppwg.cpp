...
class CellMutationStatesCountWriter2_2_Overloads : public CellMutationStatesCountWriter2_2{
    public:
...
py::class_<CellMutationStatesCountWriter2_2 , CellMutationStatesCountWriter2_2_Overloads , boost::shared_ptr<CellMutationStatesCountWriter2_2 >  , AbstractCellPopulationCountWriter<2, 2>  >(m, "CellMutationStatesCountWriter2_2")
        .def(py::init< >())
        .def(
            "WriteHeader", 
            (void(CellMutationStatesCountWriter2_2::*)(::AbstractCellPopulation<2, 2> *)) &CellMutationStatesCountWriter2_2::WriteHeader, 
            " " , py::arg("pCellPopulation") )
        .def(
            "VisitAnyPopulation", 
            (void(CellMutationStatesCountWriter2_2::*)(::AbstractCellPopulation<2, 2> *)) &CellMutationStatesCountWriter2_2::VisitAnyPopulation, 
            " " , py::arg("pCellPopulation") )
        .def(
            "Visit", 
            (void(CellMutationStatesCountWriter2_2::*)(::MeshBasedCellPopulation<2, 2> *)) &CellMutationStatesCountWriter2_2::Visit, 
            " " , py::arg("pCellPopulation") )
        .def(
            "Visit", 
