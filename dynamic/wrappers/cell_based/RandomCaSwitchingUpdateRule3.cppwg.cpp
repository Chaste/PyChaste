...
class RandomCaSwitchingUpdateRule3_Overloads : public RandomCaSwitchingUpdateRule3{
    public:
...
py::class_<RandomCaSwitchingUpdateRule3 , RandomCaSwitchingUpdateRule3_Overloads , boost::shared_ptr<RandomCaSwitchingUpdateRule3 >  , AbstractCaSwitchingUpdateRule<3>  >(m, "RandomCaSwitchingUpdateRule3")
        .def(py::init< >())
        .def(
            "EvaluateSwitchingProbability", 
