...
class NodeVelocityWriter2_2_Overloads : public NodeVelocityWriter2_2{
    public:
...
py::class_<NodeVelocityWriter2_2 , NodeVelocityWriter2_2_Overloads , boost::shared_ptr<NodeVelocityWriter2_2 >  , AbstractCellPopulationWriter<2, 2>  >(m, "NodeVelocityWriter2_2")
        .def(py::init< >())
        .def(
            "Visit", 
            (void(NodeVelocityWriter2_2::*)(::MeshBasedCellPopulation<2, 2> *)) &NodeVelocityWriter2_2::Visit, 
