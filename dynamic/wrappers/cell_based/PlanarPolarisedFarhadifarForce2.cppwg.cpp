...
class PlanarPolarisedFarhadifarForce2_Overloads : public PlanarPolarisedFarhadifarForce2{
    public:
...
py::class_<PlanarPolarisedFarhadifarForce2 , PlanarPolarisedFarhadifarForce2_Overloads , boost::shared_ptr<PlanarPolarisedFarhadifarForce2 >  , FarhadifarForce<2>  >(m, "PlanarPolarisedFarhadifarForce2")
        .def(py::init< >())
        .def(
