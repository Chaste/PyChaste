...
py::class_<AbstractTwoBodyInteractionForce3_3 , AbstractTwoBodyInteractionForce3_3_Overloads , boost::shared_ptr<AbstractTwoBodyInteractionForce3_3 >  , AbstractForce<3, 3>  >(m, "AbstractTwoBodyInteractionForce3_3")
        .def(
            "GetUseCutOffLength", 
