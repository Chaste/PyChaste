...
class CellLocationIndexWriter2_2_Overloads : public CellLocationIndexWriter2_2{
    public:
...
py::class_<CellLocationIndexWriter2_2 , CellLocationIndexWriter2_2_Overloads , boost::shared_ptr<CellLocationIndexWriter2_2 >  , AbstractCellWriter<2, 2>  >(m, "CellLocationIndexWriter2_2")
        .def(py::init< >())
        .def(
            "GetCellDataForVtkOutput", 
            (double(CellLocationIndexWriter2_2::*)(::CellPtr, ::AbstractCellPopulation<2, 2> *)) &CellLocationIndexWriter2_2::GetCellDataForVtkOutput, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
        .def(
            "VisitCell", 
            (void(CellLocationIndexWriter2_2::*)(::CellPtr, ::AbstractCellPopulation<2, 2> *)) &CellLocationIndexWriter2_2::VisitCell, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
    ;
}
