...
class LegacyCellProliferativeTypesWriter3_3_Overloads : public LegacyCellProliferativeTypesWriter3_3{
    public:
...
py::class_<LegacyCellProliferativeTypesWriter3_3 , LegacyCellProliferativeTypesWriter3_3_Overloads , boost::shared_ptr<LegacyCellProliferativeTypesWriter3_3 >  , AbstractCellWriter<3, 3>  >(m, "LegacyCellProliferativeTypesWriter3_3")
        .def(py::init< >())
        .def(
            "GetCellDataForVtkOutput", 
            (double(LegacyCellProliferativeTypesWriter3_3::*)(::CellPtr, ::AbstractCellPopulation<3, 3> *)) &LegacyCellProliferativeTypesWriter3_3::GetCellDataForVtkOutput, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
        .def(
            "VisitCell", 
            (void(LegacyCellProliferativeTypesWriter3_3::*)(::CellPtr, ::AbstractCellPopulation<3, 3> *)) &LegacyCellProliferativeTypesWriter3_3::VisitCell, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
    ;
}
