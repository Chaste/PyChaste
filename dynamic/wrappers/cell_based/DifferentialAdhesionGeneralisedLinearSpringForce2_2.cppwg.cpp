...
class DifferentialAdhesionGeneralisedLinearSpringForce2_2_Overloads : public DifferentialAdhesionGeneralisedLinearSpringForce2_2{
    public:
...
py::class_<DifferentialAdhesionGeneralisedLinearSpringForce2_2 , DifferentialAdhesionGeneralisedLinearSpringForce2_2_Overloads , boost::shared_ptr<DifferentialAdhesionGeneralisedLinearSpringForce2_2 >  , GeneralisedLinearSpringForce<2, 2>  >(m, "DifferentialAdhesionGeneralisedLinearSpringForce2_2")
        .def(py::init< >())
        .def(
            "VariableSpringConstantMultiplicationFactor", 
            (double(DifferentialAdhesionGeneralisedLinearSpringForce2_2::*)(unsigned int, unsigned int, ::AbstractCellPopulation<2, 2> &, bool)) &DifferentialAdhesionGeneralisedLinearSpringForce2_2::VariableSpringConstantMultiplicationFactor, 
