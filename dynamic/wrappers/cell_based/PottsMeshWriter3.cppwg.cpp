...
class PottsMeshWriter3_Overloads : public PottsMeshWriter3{
    public:
...
py::class_<PottsMeshWriter3 , PottsMeshWriter3_Overloads , boost::shared_ptr<PottsMeshWriter3 >   >(m, "PottsMeshWriter3")
