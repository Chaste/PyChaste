...
class DeltaNotchSrnModel_Overloads : public DeltaNotchSrnModel{
    public:
...
py::class_<DeltaNotchSrnModel , DeltaNotchSrnModel_Overloads , boost::shared_ptr<DeltaNotchSrnModel >  , AbstractOdeSrnModel  >(m, "DeltaNotchSrnModel")
