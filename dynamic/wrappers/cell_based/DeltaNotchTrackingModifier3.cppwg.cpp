...
py::class_<DeltaNotchTrackingModifier3 , DeltaNotchTrackingModifier3_Overloads , boost::shared_ptr<DeltaNotchTrackingModifier3 >   >(m, "DeltaNotchTrackingModifier3")
        .def(py::init< >())
        .def(
            "UpdateAtEndOfTimeStep", 
