...
class AbstractCaBasedDivisionRule2_Overloads : public AbstractCaBasedDivisionRule2{
    public:
...
py::class_<AbstractCaBasedDivisionRule2 , AbstractCaBasedDivisionRule2_Overloads , boost::shared_ptr<AbstractCaBasedDivisionRule2 >   >(m, "AbstractCaBasedDivisionRule2")
        .def(py::init< >())
        .def(
            "IsRoomToDivide", 
