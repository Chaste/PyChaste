...
class CellPopulationAdjacencyMatrixWriter2_2_Overloads : public CellPopulationAdjacencyMatrixWriter2_2{
    public:
...
py::class_<CellPopulationAdjacencyMatrixWriter2_2 , CellPopulationAdjacencyMatrixWriter2_2_Overloads , boost::shared_ptr<CellPopulationAdjacencyMatrixWriter2_2 >  , AbstractCellPopulationWriter<2, 2>  >(m, "CellPopulationAdjacencyMatrixWriter2_2")
        .def(py::init< >())
        .def(
            "VisitAnyPopulation", 
            (void(CellPopulationAdjacencyMatrixWriter2_2::*)(::AbstractCellPopulation<2, 2> *)) &CellPopulationAdjacencyMatrixWriter2_2::VisitAnyPopulation, 
            " " , py::arg("pCellPopulation") )
        .def(
            "Visit", 
            (void(CellPopulationAdjacencyMatrixWriter2_2::*)(::MeshBasedCellPopulation<2, 2> *)) &CellPopulationAdjacencyMatrixWriter2_2::Visit, 
            " " , py::arg("pCellPopulation") )
        .def(
            "Visit", 
