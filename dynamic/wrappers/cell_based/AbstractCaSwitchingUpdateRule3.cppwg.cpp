...
class AbstractCaSwitchingUpdateRule3_Overloads : public AbstractCaSwitchingUpdateRule3{
    public:
...
py::class_<AbstractCaSwitchingUpdateRule3 , AbstractCaSwitchingUpdateRule3_Overloads , boost::shared_ptr<AbstractCaSwitchingUpdateRule3 >  , AbstractUpdateRule<3>  >(m, "AbstractCaSwitchingUpdateRule3")
        .def(
            "EvaluateSwitchingProbability", 
