...
class CellAgesWriter2_2_Overloads : public CellAgesWriter2_2{
    public:
...
py::class_<CellAgesWriter2_2 , CellAgesWriter2_2_Overloads , boost::shared_ptr<CellAgesWriter2_2 >  , AbstractCellWriter<2, 2>  >(m, "CellAgesWriter2_2")
        .def(py::init< >())
        .def(
            "GetCellDataForVtkOutput", 
            (double(CellAgesWriter2_2::*)(::CellPtr, ::AbstractCellPopulation<2, 2> *)) &CellAgesWriter2_2::GetCellDataForVtkOutput, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
        .def(
            "VisitCell", 
            (void(CellAgesWriter2_2::*)(::CellPtr, ::AbstractCellPopulation<2, 2> *)) &CellAgesWriter2_2::VisitCell, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
    ;
}
