...
class CellDeltaNotchWriter2_2_Overloads : public CellDeltaNotchWriter2_2{
    public:
...
py::class_<CellDeltaNotchWriter2_2 , CellDeltaNotchWriter2_2_Overloads , boost::shared_ptr<CellDeltaNotchWriter2_2 >  , AbstractCellWriter<2, 2>  >(m, "CellDeltaNotchWriter2_2")
        .def(py::init< >())
        .def(
            "GetCellDataForVtkOutput", 
            (double(CellDeltaNotchWriter2_2::*)(::CellPtr, ::AbstractCellPopulation<2, 2> *)) &CellDeltaNotchWriter2_2::GetCellDataForVtkOutput, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
        .def(
            "VisitCell", 
            (void(CellDeltaNotchWriter2_2::*)(::CellPtr, ::AbstractCellPopulation<2, 2> *)) &CellDeltaNotchWriter2_2::VisitCell, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
    ;
}
