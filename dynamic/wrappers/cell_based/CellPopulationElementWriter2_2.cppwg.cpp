...
class CellPopulationElementWriter2_2_Overloads : public CellPopulationElementWriter2_2{
    public:
...
py::class_<CellPopulationElementWriter2_2 , CellPopulationElementWriter2_2_Overloads , boost::shared_ptr<CellPopulationElementWriter2_2 >  , AbstractCellPopulationWriter<2, 2>  >(m, "CellPopulationElementWriter2_2")
        .def(py::init< >())
        .def(
            "Visit", 
            (void(CellPopulationElementWriter2_2::*)(::MeshBasedCellPopulation<2, 2> *)) &CellPopulationElementWriter2_2::Visit, 
