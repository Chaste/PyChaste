...
class CellDataItemWriter3_3_Overloads : public CellDataItemWriter3_3{
    public:
...
py::class_<CellDataItemWriter3_3 , CellDataItemWriter3_3_Overloads , boost::shared_ptr<CellDataItemWriter3_3 >  , AbstractCellWriter<3, 3>  >(m, "CellDataItemWriter3_3")
        .def(py::init<::std::string >(), py::arg("cellDataVariableName") = "")
        .def(
            "GetCellDataForVtkOutput", 
            (double(CellDataItemWriter3_3::*)(::CellPtr, ::AbstractCellPopulation<3, 3> *)) &CellDataItemWriter3_3::GetCellDataForVtkOutput, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
        .def(
            "VisitCell", 
            (void(CellDataItemWriter3_3::*)(::CellPtr, ::AbstractCellPopulation<3, 3> *)) &CellDataItemWriter3_3::VisitCell, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
        .def(
