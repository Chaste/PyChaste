...
class RadialCellDataDistributionWriter2_2_Overloads : public RadialCellDataDistributionWriter2_2{
    public:
...
py::class_<RadialCellDataDistributionWriter2_2 , RadialCellDataDistributionWriter2_2_Overloads , boost::shared_ptr<RadialCellDataDistributionWriter2_2 >  , AbstractCellPopulationWriter<2, 2>  >(m, "RadialCellDataDistributionWriter2_2")
        .def(py::init< >())
        .def(
            "VisitAnyPopulation", 
            (void(RadialCellDataDistributionWriter2_2::*)(::AbstractCellPopulation<2, 2> *)) &RadialCellDataDistributionWriter2_2::VisitAnyPopulation, 
            " " , py::arg("pCellPopulation") )
        .def(
            "Visit", 
            (void(RadialCellDataDistributionWriter2_2::*)(::MeshBasedCellPopulation<2, 2> *)) &RadialCellDataDistributionWriter2_2::Visit, 
            " " , py::arg("pCellPopulation") )
        .def(
            "Visit", 
