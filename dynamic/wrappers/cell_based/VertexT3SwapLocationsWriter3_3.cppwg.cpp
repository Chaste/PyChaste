...
class VertexT3SwapLocationsWriter3_3_Overloads : public VertexT3SwapLocationsWriter3_3{
    public:
...
py::class_<VertexT3SwapLocationsWriter3_3 , VertexT3SwapLocationsWriter3_3_Overloads , boost::shared_ptr<VertexT3SwapLocationsWriter3_3 >  , AbstractCellPopulationWriter<3, 3>  >(m, "VertexT3SwapLocationsWriter3_3")
        .def(py::init< >())
        .def(
            "Visit", 
            (void(VertexT3SwapLocationsWriter3_3::*)(::MeshBasedCellPopulation<3, 3> *)) &VertexT3SwapLocationsWriter3_3::Visit, 
