...
class AbstractOdeBasedCellCycleModel_Overloads : public AbstractOdeBasedCellCycleModel{
    public:
...
py::class_<AbstractOdeBasedCellCycleModel , AbstractOdeBasedCellCycleModel_Overloads , boost::shared_ptr<AbstractOdeBasedCellCycleModel >  , AbstractCellCycleModel  >(m, "AbstractOdeBasedCellCycleModel")
        .def(
            "GetOdeStopTime", 
