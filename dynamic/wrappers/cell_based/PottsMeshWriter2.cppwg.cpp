...
class PottsMeshWriter2_Overloads : public PottsMeshWriter2{
    public:
...
py::class_<PottsMeshWriter2 , PottsMeshWriter2_Overloads , boost::shared_ptr<PottsMeshWriter2 >   >(m, "PottsMeshWriter2")
