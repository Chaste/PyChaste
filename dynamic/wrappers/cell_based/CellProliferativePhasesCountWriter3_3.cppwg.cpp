...
class CellProliferativePhasesCountWriter3_3_Overloads : public CellProliferativePhasesCountWriter3_3{
    public:
...
py::class_<CellProliferativePhasesCountWriter3_3 , CellProliferativePhasesCountWriter3_3_Overloads , boost::shared_ptr<CellProliferativePhasesCountWriter3_3 >  , AbstractCellPopulationCountWriter<3, 3>  >(m, "CellProliferativePhasesCountWriter3_3")
        .def(py::init< >())
        .def(
            "VisitAnyPopulation", 
            (void(CellProliferativePhasesCountWriter3_3::*)(::AbstractCellPopulation<3, 3> *)) &CellProliferativePhasesCountWriter3_3::VisitAnyPopulation, 
            " " , py::arg("pCellPopulation") )
        .def(
            "Visit", 
            (void(CellProliferativePhasesCountWriter3_3::*)(::MeshBasedCellPopulation<3, 3> *)) &CellProliferativePhasesCountWriter3_3::Visit, 
            " " , py::arg("pCellPopulation") )
        .def(
            "Visit", 
