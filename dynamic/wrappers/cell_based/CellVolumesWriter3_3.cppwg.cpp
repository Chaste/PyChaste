...
class CellVolumesWriter3_3_Overloads : public CellVolumesWriter3_3{
    public:
...
py::class_<CellVolumesWriter3_3 , CellVolumesWriter3_3_Overloads , boost::shared_ptr<CellVolumesWriter3_3 >  , AbstractCellWriter<3, 3>  >(m, "CellVolumesWriter3_3")
        .def(py::init< >())
        .def(
            "GetCellDataForVtkOutput", 
            (double(CellVolumesWriter3_3::*)(::CellPtr, ::AbstractCellPopulation<3, 3> *)) &CellVolumesWriter3_3::GetCellDataForVtkOutput, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
        .def(
            "VisitCell", 
            (void(CellVolumesWriter3_3::*)(::CellPtr, ::AbstractCellPopulation<3, 3> *)) &CellVolumesWriter3_3::VisitCell, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
    ;
}
