...
class CellSrnModel_Overloads : public CellSrnModel{
    public:
...
py::class_<CellSrnModel , CellSrnModel_Overloads , boost::shared_ptr<CellSrnModel >  , AbstractSrnModel  >(m, "CellSrnModel")
        .def(py::init< >())
        .def(
            "begin", 
