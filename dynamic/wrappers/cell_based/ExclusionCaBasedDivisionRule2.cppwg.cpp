...
class ExclusionCaBasedDivisionRule2_Overloads : public ExclusionCaBasedDivisionRule2{
    public:
...
py::class_<ExclusionCaBasedDivisionRule2 , ExclusionCaBasedDivisionRule2_Overloads , boost::shared_ptr<ExclusionCaBasedDivisionRule2 >  , AbstractCaBasedDivisionRule<2>  >(m, "ExclusionCaBasedDivisionRule2")
        .def(py::init< >())
        .def(
            "IsRoomToDivide", 
