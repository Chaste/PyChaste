...
class ExponentialG1GenerationalCellCycleModel_Overloads : public ExponentialG1GenerationalCellCycleModel{
    public:
...
py::class_<ExponentialG1GenerationalCellCycleModel , ExponentialG1GenerationalCellCycleModel_Overloads , boost::shared_ptr<ExponentialG1GenerationalCellCycleModel >  , AbstractSimpleGenerationalCellCycleModel  >(m, "ExponentialG1GenerationalCellCycleModel")
        .def(py::init< >())
        .def(
            "CreateCellCycleModel", 
