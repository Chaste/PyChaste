...
class AlwaysDivideCellCycleModel_Overloads : public AlwaysDivideCellCycleModel{
    public:
...
py::class_<AlwaysDivideCellCycleModel , AlwaysDivideCellCycleModel_Overloads , boost::shared_ptr<AlwaysDivideCellCycleModel >  , AbstractCellCycleModel  >(m, "AlwaysDivideCellCycleModel")
        .def(py::init< >())
        .def(
            "ReadyToDivide", 
