...
class T2SwapCellKiller2_Overloads : public T2SwapCellKiller2{
    public:
...
py::class_<T2SwapCellKiller2 , T2SwapCellKiller2_Overloads , boost::shared_ptr<T2SwapCellKiller2 >  , AbstractCellKiller<2>  >(m, "T2SwapCellKiller2")
