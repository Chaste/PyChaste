...
class CellRadiusWriter3_3_Overloads : public CellRadiusWriter3_3{
    public:
...
py::class_<CellRadiusWriter3_3 , CellRadiusWriter3_3_Overloads , boost::shared_ptr<CellRadiusWriter3_3 >  , AbstractCellWriter<3, 3>  >(m, "CellRadiusWriter3_3")
        .def(py::init< >())
        .def(
            "GetCellDataForVtkOutput", 
            (double(CellRadiusWriter3_3::*)(::CellPtr, ::AbstractCellPopulation<3, 3> *)) &CellRadiusWriter3_3::GetCellDataForVtkOutput, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
        .def(
            "VisitCell", 
            (void(CellRadiusWriter3_3::*)(::CellPtr, ::AbstractCellPopulation<3, 3> *)) &CellRadiusWriter3_3::VisitCell, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
    ;
}
