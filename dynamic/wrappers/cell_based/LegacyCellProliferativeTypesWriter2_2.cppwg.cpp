...
class LegacyCellProliferativeTypesWriter2_2_Overloads : public LegacyCellProliferativeTypesWriter2_2{
    public:
...
py::class_<LegacyCellProliferativeTypesWriter2_2 , LegacyCellProliferativeTypesWriter2_2_Overloads , boost::shared_ptr<LegacyCellProliferativeTypesWriter2_2 >  , AbstractCellWriter<2, 2>  >(m, "LegacyCellProliferativeTypesWriter2_2")
        .def(py::init< >())
        .def(
            "GetCellDataForVtkOutput", 
            (double(LegacyCellProliferativeTypesWriter2_2::*)(::CellPtr, ::AbstractCellPopulation<2, 2> *)) &LegacyCellProliferativeTypesWriter2_2::GetCellDataForVtkOutput, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
        .def(
            "VisitCell", 
            (void(LegacyCellProliferativeTypesWriter2_2::*)(::CellPtr, ::AbstractCellPopulation<2, 2> *)) &LegacyCellProliferativeTypesWriter2_2::VisitCell, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
    ;
}
