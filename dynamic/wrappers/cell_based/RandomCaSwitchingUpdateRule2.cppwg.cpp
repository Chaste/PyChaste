...
class RandomCaSwitchingUpdateRule2_Overloads : public RandomCaSwitchingUpdateRule2{
    public:
...
py::class_<RandomCaSwitchingUpdateRule2 , RandomCaSwitchingUpdateRule2_Overloads , boost::shared_ptr<RandomCaSwitchingUpdateRule2 >  , AbstractCaSwitchingUpdateRule<2>  >(m, "RandomCaSwitchingUpdateRule2")
        .def(py::init< >())
        .def(
            "EvaluateSwitchingProbability", 
