...
class ExclusionCaBasedDivisionRule3_Overloads : public ExclusionCaBasedDivisionRule3{
    public:
...
py::class_<ExclusionCaBasedDivisionRule3 , ExclusionCaBasedDivisionRule3_Overloads , boost::shared_ptr<ExclusionCaBasedDivisionRule3 >  , AbstractCaBasedDivisionRule<3>  >(m, "ExclusionCaBasedDivisionRule3")
        .def(py::init< >())
        .def(
            "IsRoomToDivide", 
