...
class AbstractCaBasedDivisionRule3_Overloads : public AbstractCaBasedDivisionRule3{
    public:
...
py::class_<AbstractCaBasedDivisionRule3 , AbstractCaBasedDivisionRule3_Overloads , boost::shared_ptr<AbstractCaBasedDivisionRule3 >   >(m, "AbstractCaBasedDivisionRule3")
        .def(py::init< >())
        .def(
            "IsRoomToDivide", 
