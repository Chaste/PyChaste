...
class AbstractCellWriter3_3_Overloads : public AbstractCellWriter3_3{
    public:
...
py::class_<AbstractCellWriter3_3 , AbstractCellWriter3_3_Overloads , boost::shared_ptr<AbstractCellWriter3_3 >  , AbstractCellBasedWriter<3, 3>  >(m, "AbstractCellWriter3_3")
        .def(py::init<::std::string const & >(), py::arg("rFileName"))
        .def(
            "GetCellDataForVtkOutput", 
            (double(AbstractCellWriter3_3::*)(::CellPtr, ::AbstractCellPopulation<3, 3> *)) &AbstractCellWriter3_3::GetCellDataForVtkOutput, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
        .def(
            "GetVectorCellDataForVtkOutput", 
            (::boost::numeric::ublas::c_vector<double, 3>(AbstractCellWriter3_3::*)(::CellPtr, ::AbstractCellPopulation<3, 3> *)) &AbstractCellWriter3_3::GetVectorCellDataForVtkOutput, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
        .def(
            "VisitCell", 
            (void(AbstractCellWriter3_3::*)(::CellPtr, ::AbstractCellPopulation<3, 3> *)) &AbstractCellWriter3_3::VisitCell, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
        .def(
            "GetOutputScalarData", 
