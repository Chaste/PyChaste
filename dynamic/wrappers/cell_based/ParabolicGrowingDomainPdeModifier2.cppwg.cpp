...
class ParabolicGrowingDomainPdeModifier2_Overloads : public ParabolicGrowingDomainPdeModifier2{
    public:
...
py::class_<ParabolicGrowingDomainPdeModifier2 , ParabolicGrowingDomainPdeModifier2_Overloads , boost::shared_ptr<ParabolicGrowingDomainPdeModifier2 >  , AbstractGrowingDomainPdeModifier<2>  >(m, "ParabolicGrowingDomainPdeModifier2")
        .def(py::init<::boost::shared_ptr<AbstractLinearPde<2>>, ::boost::shared_ptr<AbstractBoundaryCondition<2>>, bool, ::Vec >(), py::arg("pPde") = boost::shared_ptr<AbstractLinearPde<2, 2>>(), py::arg("pBoundaryCondition") = boost::shared_ptr<AbstractBoundaryCondition<2>>(), py::arg("isNeumannBoundaryCondition") = true, py::arg("solution") = nullptr)
        .def(
            "UpdateAtEndOfTimeStep", 
            (void(ParabolicGrowingDomainPdeModifier2::*)(::AbstractCellPopulation<2, 2> &)) &ParabolicGrowingDomainPdeModifier2::UpdateAtEndOfTimeStep, 
            " " , py::arg("rCellPopulation") )
        .def(
            "SetupSolve", 
            (void(ParabolicGrowingDomainPdeModifier2::*)(::AbstractCellPopulation<2, 2> &, ::std::string)) &ParabolicGrowingDomainPdeModifier2::SetupSolve, 
            " " , py::arg("rCellPopulation"), py::arg("outputDirectory") )
        .def(
            "UpdateSolutionVector", 
            (void(ParabolicGrowingDomainPdeModifier2::*)(::AbstractCellPopulation<2, 2> &)) &ParabolicGrowingDomainPdeModifier2::UpdateSolutionVector, 
            " " , py::arg("rCellPopulation") )
        .def(
            "OutputSimulationModifierParameters", 
