...
class CellDataItemWriter2_2_Overloads : public CellDataItemWriter2_2{
    public:
...
py::class_<CellDataItemWriter2_2 , CellDataItemWriter2_2_Overloads , boost::shared_ptr<CellDataItemWriter2_2 >  , AbstractCellWriter<2, 2>  >(m, "CellDataItemWriter2_2")
        .def(py::init<::std::string >(), py::arg("cellDataVariableName") = "")
        .def(
            "GetCellDataForVtkOutput", 
            (double(CellDataItemWriter2_2::*)(::CellPtr, ::AbstractCellPopulation<2, 2> *)) &CellDataItemWriter2_2::GetCellDataForVtkOutput, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
        .def(
            "VisitCell", 
            (void(CellDataItemWriter2_2::*)(::CellPtr, ::AbstractCellPopulation<2, 2> *)) &CellDataItemWriter2_2::VisitCell, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
        .def(
