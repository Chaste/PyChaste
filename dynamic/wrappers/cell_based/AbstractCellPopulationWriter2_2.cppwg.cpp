...
class AbstractCellPopulationWriter2_2_Overloads : public AbstractCellPopulationWriter2_2{
    public:
...
py::class_<AbstractCellPopulationWriter2_2 , AbstractCellPopulationWriter2_2_Overloads , boost::shared_ptr<AbstractCellPopulationWriter2_2 >  , AbstractCellBasedWriter<2, 2>  >(m, "AbstractCellPopulationWriter2_2")
        .def(py::init<::std::string const & >(), py::arg("rFileName"))
        .def(
            "WriteHeader", 
            (void(AbstractCellPopulationWriter2_2::*)(::AbstractCellPopulation<2, 2> *)) &AbstractCellPopulationWriter2_2::WriteHeader, 
            " " , py::arg("pCellPopulation") )
        .def(
            "Visit", 
            (void(AbstractCellPopulationWriter2_2::*)(::MeshBasedCellPopulation<2, 2> *)) &AbstractCellPopulationWriter2_2::Visit, 
            " " , py::arg("pCellPopulation") )
        .def(
            "Visit", 
