...
class CellAncestorWriter2_2_Overloads : public CellAncestorWriter2_2{
    public:
...
py::class_<CellAncestorWriter2_2 , CellAncestorWriter2_2_Overloads , boost::shared_ptr<CellAncestorWriter2_2 >  , AbstractCellWriter<2, 2>  >(m, "CellAncestorWriter2_2")
        .def(py::init< >())
        .def(
            "GetCellDataForVtkOutput", 
            (double(CellAncestorWriter2_2::*)(::CellPtr, ::AbstractCellPopulation<2, 2> *)) &CellAncestorWriter2_2::GetCellDataForVtkOutput, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
        .def(
            "VisitCell", 
            (void(CellAncestorWriter2_2::*)(::CellPtr, ::AbstractCellPopulation<2, 2> *)) &CellAncestorWriter2_2::VisitCell, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
    ;
}
