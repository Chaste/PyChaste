...
class CellVolumesWriter2_2_Overloads : public CellVolumesWriter2_2{
    public:
...
py::class_<CellVolumesWriter2_2 , CellVolumesWriter2_2_Overloads , boost::shared_ptr<CellVolumesWriter2_2 >  , AbstractCellWriter<2, 2>  >(m, "CellVolumesWriter2_2")
        .def(py::init< >())
        .def(
            "GetCellDataForVtkOutput", 
            (double(CellVolumesWriter2_2::*)(::CellPtr, ::AbstractCellPopulation<2, 2> *)) &CellVolumesWriter2_2::GetCellDataForVtkOutput, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
        .def(
            "VisitCell", 
            (void(CellVolumesWriter2_2::*)(::CellPtr, ::AbstractCellPopulation<2, 2> *)) &CellVolumesWriter2_2::VisitCell, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
    ;
}
