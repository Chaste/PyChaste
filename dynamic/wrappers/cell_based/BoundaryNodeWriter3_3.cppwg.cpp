...
class BoundaryNodeWriter3_3_Overloads : public BoundaryNodeWriter3_3{
    public:
...
py::class_<BoundaryNodeWriter3_3 , BoundaryNodeWriter3_3_Overloads , boost::shared_ptr<BoundaryNodeWriter3_3 >  , AbstractCellPopulationWriter<3, 3>  >(m, "BoundaryNodeWriter3_3")
        .def(py::init< >())
        .def(
            "VisitAnyPopulation", 
            (void(BoundaryNodeWriter3_3::*)(::AbstractCellPopulation<3, 3> *)) &BoundaryNodeWriter3_3::VisitAnyPopulation, 
            " " , py::arg("pCellPopulation") )
        .def(
            "Visit", 
            (void(BoundaryNodeWriter3_3::*)(::MeshBasedCellPopulation<3, 3> *)) &BoundaryNodeWriter3_3::Visit, 
            " " , py::arg("pCellPopulation") )
        .def(
            "Visit", 
