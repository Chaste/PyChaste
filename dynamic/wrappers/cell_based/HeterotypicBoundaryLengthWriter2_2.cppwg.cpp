...
class HeterotypicBoundaryLengthWriter2_2_Overloads : public HeterotypicBoundaryLengthWriter2_2{
    public:
...
py::class_<HeterotypicBoundaryLengthWriter2_2 , HeterotypicBoundaryLengthWriter2_2_Overloads , boost::shared_ptr<HeterotypicBoundaryLengthWriter2_2 >  , AbstractCellPopulationWriter<2, 2>  >(m, "HeterotypicBoundaryLengthWriter2_2")
        .def(py::init< >())
        .def(
            "Visit", 
            (void(HeterotypicBoundaryLengthWriter2_2::*)(::MeshBasedCellPopulation<2, 2> *)) &HeterotypicBoundaryLengthWriter2_2::Visit, 
