...
class CellRemovalLocationsWriter3_3_Overloads : public CellRemovalLocationsWriter3_3{
    public:
...
py::class_<CellRemovalLocationsWriter3_3 , CellRemovalLocationsWriter3_3_Overloads , boost::shared_ptr<CellRemovalLocationsWriter3_3 >  , AbstractCellPopulationEventWriter<3, 3>  >(m, "CellRemovalLocationsWriter3_3")
        .def(py::init< >())
        .def(
            "VisitAnyPopulation", 
            (void(CellRemovalLocationsWriter3_3::*)(::AbstractCellPopulation<3, 3> *)) &CellRemovalLocationsWriter3_3::VisitAnyPopulation, 
            " " , py::arg("pCellPopulation") )
        .def(
            "Visit", 
            (void(CellRemovalLocationsWriter3_3::*)(::MeshBasedCellPopulation<3, 3> *)) &CellRemovalLocationsWriter3_3::Visit, 
            " " , py::arg("pCellPopulation") )
        .def(
            "Visit", 
