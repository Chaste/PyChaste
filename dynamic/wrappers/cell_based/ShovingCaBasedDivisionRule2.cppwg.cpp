...
class ShovingCaBasedDivisionRule2_Overloads : public ShovingCaBasedDivisionRule2{
    public:
...
py::class_<ShovingCaBasedDivisionRule2 , ShovingCaBasedDivisionRule2_Overloads , boost::shared_ptr<ShovingCaBasedDivisionRule2 >  , AbstractCaBasedDivisionRule<2>  >(m, "ShovingCaBasedDivisionRule2")
        .def(py::init< >())
        .def(
            "IsNodeOnBoundary", 
