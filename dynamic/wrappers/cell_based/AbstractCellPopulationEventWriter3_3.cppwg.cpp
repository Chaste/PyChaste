...
class AbstractCellPopulationEventWriter3_3_Overloads : public AbstractCellPopulationEventWriter3_3{
    public:
...
py::class_<AbstractCellPopulationEventWriter3_3 , AbstractCellPopulationEventWriter3_3_Overloads , boost::shared_ptr<AbstractCellPopulationEventWriter3_3 >  , AbstractCellBasedWriter<3, 3>  >(m, "AbstractCellPopulationEventWriter3_3")
        .def(py::init<::std::string const & >(), py::arg("rFileName"))
        .def(
            "WriteHeader", 
            (void(AbstractCellPopulationEventWriter3_3::*)(::AbstractCellPopulation<3, 3> *)) &AbstractCellPopulationEventWriter3_3::WriteHeader, 
            " " , py::arg("pCellPopulation") )
        .def(
            "Visit", 
            (void(AbstractCellPopulationEventWriter3_3::*)(::MeshBasedCellPopulation<3, 3> *)) &AbstractCellPopulationEventWriter3_3::Visit, 
            " " , py::arg("pCellPopulation") )
        .def(
            "Visit", 
