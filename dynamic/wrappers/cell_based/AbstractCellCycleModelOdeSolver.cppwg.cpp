...
class AbstractCellCycleModelOdeSolver_Overloads : public AbstractCellCycleModelOdeSolver{
    public:
...
py::class_<AbstractCellCycleModelOdeSolver , AbstractCellCycleModelOdeSolver_Overloads , boost::shared_ptr<AbstractCellCycleModelOdeSolver >   >(m, "AbstractCellCycleModelOdeSolver")
        .def(py::init< >())
        .def(
            "IsSetUp", 
