...
class ChemotaxisPottsUpdateRule2_Overloads : public ChemotaxisPottsUpdateRule2{
    public:
...
py::class_<ChemotaxisPottsUpdateRule2 , ChemotaxisPottsUpdateRule2_Overloads , boost::shared_ptr<ChemotaxisPottsUpdateRule2 >  , AbstractPottsUpdateRule<2>  >(m, "ChemotaxisPottsUpdateRule2")
        .def(py::init< >())
        .def(
            "EvaluateHamiltonianContribution", 
