...
class VonMisesVertexBasedDivisionRule2_Overloads : public VonMisesVertexBasedDivisionRule2{
    public:
...
py::class_<VonMisesVertexBasedDivisionRule2 , VonMisesVertexBasedDivisionRule2_Overloads , boost::shared_ptr<VonMisesVertexBasedDivisionRule2 >  , AbstractVertexBasedDivisionRule<2>  >(m, "VonMisesVertexBasedDivisionRule2")
        .def(py::init< >())
        .def(
            "GetMeanParameter", 
