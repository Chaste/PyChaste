...
class NodeLocationWriter3_3_Overloads : public NodeLocationWriter3_3{
    public:
...
py::class_<NodeLocationWriter3_3 , NodeLocationWriter3_3_Overloads , boost::shared_ptr<NodeLocationWriter3_3 >  , AbstractCellPopulationWriter<3, 3>  >(m, "NodeLocationWriter3_3")
        .def(py::init< >())
        .def(
            "VisitAnyPopulation", 
            (void(NodeLocationWriter3_3::*)(::AbstractCellPopulation<3, 3> *)) &NodeLocationWriter3_3::VisitAnyPopulation, 
            " " , py::arg("pCellPopulation") )
        .def(
            "Visit", 
            (void(NodeLocationWriter3_3::*)(::MeshBasedCellPopulation<3, 3> *)) &NodeLocationWriter3_3::Visit, 
            " " , py::arg("pCellPopulation") )
        .def(
            "Visit", 
