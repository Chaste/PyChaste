...
class CellIdWriter2_2_Overloads : public CellIdWriter2_2{
    public:
...
py::class_<CellIdWriter2_2 , CellIdWriter2_2_Overloads , boost::shared_ptr<CellIdWriter2_2 >  , AbstractCellWriter<2, 2>  >(m, "CellIdWriter2_2")
        .def(py::init< >())
        .def(
            "GetCellDataForVtkOutput", 
            (double(CellIdWriter2_2::*)(::CellPtr, ::AbstractCellPopulation<2, 2> *)) &CellIdWriter2_2::GetCellDataForVtkOutput, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
        .def(
            "VisitCell", 
            (void(CellIdWriter2_2::*)(::CellPtr, ::AbstractCellPopulation<2, 2> *)) &CellIdWriter2_2::VisitCell, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
    ;
}
