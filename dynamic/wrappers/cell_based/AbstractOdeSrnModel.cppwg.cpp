...
class AbstractOdeSrnModel_Overloads : public AbstractOdeSrnModel{
    public:
...
py::class_<AbstractOdeSrnModel , AbstractOdeSrnModel_Overloads , boost::shared_ptr<AbstractOdeSrnModel >  , AbstractSrnModel  >(m, "AbstractOdeSrnModel")
        .def(
            "SimulateToCurrentTime", 
