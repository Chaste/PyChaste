...
class RadialCellDataDistributionWriter3_3_Overloads : public RadialCellDataDistributionWriter3_3{
    public:
...
py::class_<RadialCellDataDistributionWriter3_3 , RadialCellDataDistributionWriter3_3_Overloads , boost::shared_ptr<RadialCellDataDistributionWriter3_3 >  , AbstractCellPopulationWriter<3, 3>  >(m, "RadialCellDataDistributionWriter3_3")
        .def(py::init< >())
        .def(
            "VisitAnyPopulation", 
            (void(RadialCellDataDistributionWriter3_3::*)(::AbstractCellPopulation<3, 3> *)) &RadialCellDataDistributionWriter3_3::VisitAnyPopulation, 
            " " , py::arg("pCellPopulation") )
        .def(
            "Visit", 
            (void(RadialCellDataDistributionWriter3_3::*)(::MeshBasedCellPopulation<3, 3> *)) &RadialCellDataDistributionWriter3_3::Visit, 
            " " , py::arg("pCellPopulation") )
        .def(
            "Visit", 
