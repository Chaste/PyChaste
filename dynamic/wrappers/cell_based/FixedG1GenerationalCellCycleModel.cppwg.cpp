...
class FixedG1GenerationalCellCycleModel_Overloads : public FixedG1GenerationalCellCycleModel{
    public:
...
py::class_<FixedG1GenerationalCellCycleModel , FixedG1GenerationalCellCycleModel_Overloads , boost::shared_ptr<FixedG1GenerationalCellCycleModel >  , AbstractSimpleGenerationalCellCycleModel  >(m, "FixedG1GenerationalCellCycleModel")
        .def(py::init< >())
        .def(
            "CreateCellCycleModel", 
