...
class BuskeCompressionForce3_Overloads : public BuskeCompressionForce3{
    public:
...
py::class_<BuskeCompressionForce3 , BuskeCompressionForce3_Overloads , boost::shared_ptr<BuskeCompressionForce3 >   >(m, "BuskeCompressionForce3")
        .def(py::init< >())
        .def(
