...
class CellAgesWriter3_3_Overloads : public CellAgesWriter3_3{
    public:
...
py::class_<CellAgesWriter3_3 , CellAgesWriter3_3_Overloads , boost::shared_ptr<CellAgesWriter3_3 >  , AbstractCellWriter<3, 3>  >(m, "CellAgesWriter3_3")
        .def(py::init< >())
        .def(
            "GetCellDataForVtkOutput", 
            (double(CellAgesWriter3_3::*)(::CellPtr, ::AbstractCellPopulation<3, 3> *)) &CellAgesWriter3_3::GetCellDataForVtkOutput, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
        .def(
            "VisitCell", 
            (void(CellAgesWriter3_3::*)(::CellPtr, ::AbstractCellPopulation<3, 3> *)) &CellAgesWriter3_3::VisitCell, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
    ;
}
