...
class CellAppliedForceWriter3_3_Overloads : public CellAppliedForceWriter3_3{
    public:
...
py::class_<CellAppliedForceWriter3_3 , CellAppliedForceWriter3_3_Overloads , boost::shared_ptr<CellAppliedForceWriter3_3 >  , AbstractCellWriter<3, 3>  >(m, "CellAppliedForceWriter3_3")
        .def(py::init< >())
        .def(
            "GetVectorCellDataForVtkOutput", 
            (::boost::numeric::ublas::c_vector<double, 3>(CellAppliedForceWriter3_3::*)(::CellPtr, ::AbstractCellPopulation<3, 3> *)) &CellAppliedForceWriter3_3::GetVectorCellDataForVtkOutput, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
        .def(
            "VisitCell", 
            (void(CellAppliedForceWriter3_3::*)(::CellPtr, ::AbstractCellPopulation<3, 3> *)) &CellAppliedForceWriter3_3::VisitCell, 
            " " , py::arg("pCell"), py::arg("pCellPopulation") )
    ;
}
