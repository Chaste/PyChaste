...
template class RandomDirectionCentreBasedDivisionRule<2>;
template class RandomDirectionCentreBasedDivisionRule<3>;
template class FixedCentreBasedDivisionRule<2>;
template class FixedCentreBasedDivisionRule<3>;
template class AbstractCentreBasedDivisionRule<2>;
template class AbstractCentreBasedDivisionRule<3>;
...
typedef RandomDirectionCentreBasedDivisionRule<2> RandomDirectionCentreBasedDivisionRule2;
typedef RandomDirectionCentreBasedDivisionRule<3> RandomDirectionCentreBasedDivisionRule3;
typedef FixedCentreBasedDivisionRule<2> FixedCentreBasedDivisionRule2;
typedef FixedCentreBasedDivisionRule<3> FixedCentreBasedDivisionRule3;
typedef AbstractCentreBasedDivisionRule<2> AbstractCentreBasedDivisionRule2;
typedef AbstractCentreBasedDivisionRule<3> AbstractCentreBasedDivisionRule3;
