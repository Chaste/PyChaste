...
class DeltaNotchInteriorOdeSystem_Overloads : public DeltaNotchInteriorOdeSystem{
    public:
...
py::class_<DeltaNotchInteriorOdeSystem , DeltaNotchInteriorOdeSystem_Overloads , boost::shared_ptr<DeltaNotchInteriorOdeSystem >  , AbstractOdeSystem  >(m, "DeltaNotchInteriorOdeSystem")
