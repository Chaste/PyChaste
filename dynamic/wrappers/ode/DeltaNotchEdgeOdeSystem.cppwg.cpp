...
class DeltaNotchEdgeOdeSystem_Overloads : public DeltaNotchEdgeOdeSystem{
    public:
...
py::class_<DeltaNotchEdgeOdeSystem , DeltaNotchEdgeOdeSystem_Overloads , boost::shared_ptr<DeltaNotchEdgeOdeSystem >  , AbstractOdeSystem  >(m, "DeltaNotchEdgeOdeSystem")
