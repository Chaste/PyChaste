...
class DeltaNotchOdeSystem_Overloads : public DeltaNotchOdeSystem{
    public:
...
py::class_<DeltaNotchOdeSystem , DeltaNotchOdeSystem_Overloads , boost::shared_ptr<DeltaNotchOdeSystem >  , AbstractOdeSystem  >(m, "DeltaNotchOdeSystem")
